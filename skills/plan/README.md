...
- **Decisions summary consumption** — reads a decisions summary from the conversation as the sole source of truth
...
1. **Read the decisions summary** — finds a decisions summary from earlier in the conversation.
