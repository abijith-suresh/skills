...
Turn a feature request into a clear product requirements document that is
specific enough to guide planning, issue breakdown, and implementation.

## When to Use

- You have a feature idea but need a sharper written spec.
...
- `grill-me` before drafting if the idea is still fuzzy.
- `prd-to-plan` once the PRD is approved.
- `prd-to-issues` when you want issue-sized slices.
